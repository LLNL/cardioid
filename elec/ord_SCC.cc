...
void ThisReaction::constructKernel()
{
   ...
   "double _expensive_functions_065 = exp(-0.10130685847431871*v);\n"
   "double mss = 1.0/(0.018156759019440624*_expensive_functions_065 + 1.0);\n"
   "double _expensive_functions_066 = exp(0.02876042565429968*v);\n"
   "double _expensive_functions_067 = exp(-0.16792611251049538*v);\n"
   "double tm = 1.0/(9.4549046385647237*_expensive_functions_066 + 1.9314113558536928e-5*_expensive_functions_067);\n"
   "double _expensive_functions_068 = exp(0.16431153466973381*v);\n"
   "double hss = 1.0/(823588.44496083795*_expensive_functions_068 + 1);\n"
   "double _expensive_functions_069 = exp(-0.15910898965791567*v);\n"
   "double _expensive_functions_070 = exp(0.049333991119881598*v);\n"
   "double thf = 1.0/(1.183856958289087e-5*_expensive_functions_069 + 6.3055491858172754*_expensive_functions_070);\n"
   "double jss = hss;\n"
   "double _expensive_functions_071 = exp(0.02600780234070221*v);\n"
   "double _expensive_functions_072 = exp(-0.12075836251660427*v);\n"
   "double tj = 2.0379999999999998 + 1.0/(0.31319363947387729*_expensive_functions_071 + 1.1315282095590072e-7*_expensive_functions_072);\n"
   "double _expensive_functions_073 = exp(-0.035650623885918005*v);\n"
   "double _expensive_functions_074 = exp(0.017649135192375574*v);\n"
   "double ths = 1.0/(0.0051646702353817919*_expensive_functions_073 + 0.36987619372096325*_expensive_functions_074);\n"
   "double _expensive_functions_075 = exp(0.16431153466973381*v);\n"
   "double hspss = 1.0/(2281075.8166971938*_expensive_functions_075 + 1);\n"
   "double thsp = 3.0*ths;\n"
   "double tjp = 1.46*tj;\n"
   "double tmL = tm;\n"
   "double _expensive_functions_076 = exp(-_dt/ta);\n"
   "double _a_RLA = _expensive_functions_076 - 1;\n"
   "double _a_RLB = -ass;\n"
   "double _expensive_functions_077 = exp(-_dt/ta);\n"
   "double _ap_RLA = _expensive_functions_077 - 1;\n"
   "double _ap_RLB = -apss;\n"
   "double _expensive_functions_078 = exp(-_dt/td);\n"
   "double _d_RLA = _expensive_functions_078 - 1;\n"
   "double _d_RLB = -dss;\n"
   "double _expensive_functions_079 = exp(-_dt/tfcaf);\n"
   "double _fcaf_RLA = _expensive_functions_079 - 1;\n"
   "double _fcaf_RLB = -fcass;\n"
   "double _expensive_functions_080 = exp(-_dt/tfcafp);\n"
   "double _fcafp_RLA = _expensive_functions_080 - 1;\n"
   "double _fcafp_RLB = -fcass;\n"
   "double _expensive_functions_081 = exp(-_dt/tfcas);\n"
   "double _fcas_RLA = _expensive_functions_081 - 1;\n"
   "double _fcas_RLB = -fcass;\n"
   "double _expensive_functions_082 = exp(-_dt/tff);\n"
   "double _ff_RLA = _expensive_functions_082 - 1;\n"
   "double _ff_RLB = -fss;\n"
   "double _expensive_functions_083 = exp(-_dt/tffp);\n"
   "double _ffp_RLA = _expensive_functions_083 - 1;\n"
   "double _ffp_RLB = -fss;\n"
   "double _expensive_functions_084 = exp(-_dt/tfs);\n"
   "double _fs_RLA = _expensive_functions_084 - 1;\n"
   "double _fs_RLB = -fss;\n"
   "double _expensive_functions_085 = exp(-_dt/thL);\n"
   "double _hL_RLA = _expensive_functions_085 - 1;\n"
   "double _hL_RLB = -hLss;\n"
   "double _expensive_functions_086 = exp(-_dt/thLp);\n"
   "double _hLp_RLA = _expensive_functions_086 - 1;\n"
   "double _hLp_RLB = -hLpss;\n"
   "double _expensive_functions_087 = exp(-_dt/thf);\n"
   "double _hf_RLA = _expensive_functions_087 - 1;\n"
   "double _hf_RLB = -hss;\n"
   "double _expensive_functions_088 = exp(-_dt/ths);\n"
   "double _hs_RLA = _expensive_functions_088 - 1;\n"
   "double _hs_RLB = -hss;\n"
   "double _expensive_functions_089 = exp(-_dt/thsp);\n"
   "double _hsp_RLA = _expensive_functions_089 - 1;\n"
   "double _hsp_RLB = -hspss;\n"
   "double _expensive_functions_090 = exp(-_dt/tiF_001);\n"
   "double _iF_RLA = _expensive_functions_090 - 1;\n"
   "double _iF_RLB = -iss;\n"
   "double _expensive_functions_091 = exp(-_dt/tiFp);\n"
   "double _iFp_RLA = _expensive_functions_091 - 1;\n"
   "double _iFp_RLB = -iss;\n"
   "double _expensive_functions_092 = exp(-_dt/tiS_001);\n"
   "double _iS_RLA = _expensive_functions_092 - 1;\n"
   "double _iS_RLB = -iss;\n"
   "double _expensive_functions_093 = exp(-_dt/tiSp);\n"
   "double _iSp_RLA = _expensive_functions_093 - 1;\n"
   "double _iSp_RLB = -iss;\n"
   "double _expensive_functions_094 = exp(-_dt/tj);\n"
   "double _j_RLA = _expensive_functions_094 - 1;\n"
   "double _j_RLB = -jss;\n"
   "double _expensive_functions_095 = exp(-_dt/tjca);\n"
   "double _jca_RLA = _expensive_functions_095 - 1;\n"
   "double _jca_RLB = -fcass;\n"
   "double _expensive_functions_096 = exp(-_dt/tjp);\n"
   "double _jp_RLA = _expensive_functions_096 - 1;\n"
   "double _jp_RLB = -jss;\n"
   "double _expensive_functions_097 = exp(-_dt/tm);\n"
   "double _m_RLA = _expensive_functions_097 - 1;\n"
   "double _m_RLB = -mss;\n"
   "double _expensive_functions_098 = exp(-_dt/tmL);\n"
   "double _mL_RLA = _expensive_functions_098 - 1;\n"
   "double _mL_RLB = -mLss;\n"
   "double _expensive_functions_099 = exp(-_dt*km2n);\n"
   "double _nca_RLA = _expensive_functions_099 - 1;\n"
   "double _nca_RLB = -anca*k2n/km2n;\n"
   "double _expensive_functions_100 = exp(-_dt/txk1);\n"
   "double _xk1_RLA = _expensive_functions_100 - 1;\n"
   "double _xk1_RLB = -xk1ss;\n"
   "double _expensive_functions_101 = exp(-_dt/txrf);\n"
   "double _xrf_RLA = _expensive_functions_101 - 1;\n"
   "double _xrf_RLB = -xrss;\n"
   "double _expensive_functions_102 = exp(-_dt/txrs);\n"
   "double _xrs_RLA = _expensive_functions_102 - 1;\n"
   "double _xrs_RLB = -xrss;\n"
   "double _expensive_functions_103 = exp(-_dt/txs1);\n"
   "double _xs1_RLA = _expensive_functions_103 - 1;\n"
   "double _xs1_RLB = -xs1ss;\n"
   "double _expensive_functions_104 = exp(-_dt/txs2);\n"
   "double _xs2_RLA = _expensive_functions_104 - 1;\n"
   ...
   "{\n"
   "   GNaL_001 = 0.59999999999999998*GNaL;\n"
   "}\n"
   "else\n"
   "{\n"
   "   GNaL_001 = GNaL;\n"
   ...
   "double INaL = GNaL_001*mL*(-ENa + v)*(fINaLp*hLp + hL*(1.0 - fINaLp));\n"
   ...
   "double Ito = Gto_001*(-EK + v)*(a*i*(1.0 - fItop) + ap*fItop*ip);\n"
   ...
   "   }\n"
   "}\n"
   "double PCap = 1.1000000000000001*PCa_001;\n"
   "double PCaNa = 0.00125*PCa_001;\n"
   "double PCaK = 0.00035740000000000001*PCa_001;\n"
   "double PCaNap = 0.00125*PCap;\n"
   "double PCaKp = 0.00035740000000000001*PCap;\n"
   "double fICaLp = 1.0/(1.0 + KmCaMK/CaMKa);\n"
   "double ICaL = PCa_001*PhiCaL*d*(1.0 - fICaLp)*(f*(1.0 - nca) + fca*jca*nca) + PCap*PhiCaL*d*fICaLp*(fcap*jca*nca + fp*(1.0 - nca));\n"
   ...
   "   {\n"
   "      GKr_001 = 0.80000000000000004*GKr;\n"
   "   }\n"
   "   else\n"
   "   {\n"
   "      GKr_001 = GKr;\n"
   ...
   "double IKr = 0.43033148291193518*GKr_001*_expensive_functions_046*rkr*xr*(-EK + v);\n"
   ...
   "{\n"
   "   GKs_001 = 1.3999999999999999*GKs;\n"
   "}\n"
   "else\n"
   "{\n"
   "   GKs_001 = GKs;\n"
   ...
   "{\n"
   "   Gncx_001 = 1.1000000000000001*Gncx;\n"
   "}\n"
   "else\n"
   "{\n"
   ...
   "   {\n"
   "      Gncx_001 = 1.3999999999999999*Gncx;\n"
   "   }\n"
   "   else\n"
   "   {\n"
   "      Gncx_001 = Gncx;\n"
   "   }\n"
   "}\n"
   "double INaCa_i = 0.80000000000000004*Gncx_001*allo*(JncxCa*zca + JncxNa*zna);\n"
   ...
   "double KmCaAct_001 = 0.00014999999999999999;\n"
   ...
   "double INaCa_ss = 0.20000000000000001*Gncx_001*allo_001*(JncxCa_001*zca + JncxNa_001*zna);\n"
   "double k1p = 949.5;\n"
   "double k1m = 182.40000000000001;\n"
   "double k2p = 687.20000000000005;\n"
   "double k2m = 39.399999999999999;\n"
   "double k3p_002 = 1899.0;\n"
   "double k3m = 79300.0;\n"
   "double k4p_002 = 639.0;\n"
   "double k4m = 40.0;\n"
   ...
   "{\n"
   "   Pnak_001 = 0.90000000000000002*Pnak;\n"
   "}\n"
   "else\n"
   "{\n"
   ...
   "   {\n"
   "      Pnak_001 = 0.69999999999999996*Pnak;\n"
   "   }\n"
   "   else\n"
   "   {\n"
   "      Pnak_001 = Pnak;\n"
   ...
   "{\n"
   "   GKb_001 = 0.59999999999999998*GKb;\n"
   "}\n"
   "else\n"
   "{\n"
   "   GKb_001 = GKb;\n"
   ...
   "double Jup = -Jleak + Jupnp_001*(1.0 - fJupp) + Jupp_001*fJupp;\n"
   ...
   "double GNa = 75;\n"
   "double INa = (m*m*m)*GNa*(-ENa + v)*(fINap*hp*jp + h*j*(1.0 - fINap));\n"
                ...
                wo_mgarray_ptr<double> ___dVm)
{
   ...
   for (unsigned __jj=0; __jj<(nCells_+width-1)/width; __jj++)
   {
      ...
      real tiF_001 = delta_epi*tiF;
      real tiS_001 = delta_epi*tiS;
      ...
      real tiFp = dti_develop*dti_recover*tiF_001;
      real tiSp = dti_develop*dti_recover*tiS_001;
      ...
      real _expensive_functions_065 = exp(-0.10130685847431871*v);
      real mss = 1.0/(0.018156759019440624*_expensive_functions_065 + 1.0);
      real _expensive_functions_066 = exp(0.02876042565429968*v);
      real _expensive_functions_067 = exp(-0.16792611251049538*v);
      real tm = 1.0/(9.4549046385647237*_expensive_functions_066 + 1.9314113558536928e-5*_expensive_functions_067);
      real _expensive_functions_068 = exp(0.16431153466973381*v);
      real hss = 1.0/(823588.44496083795*_expensive_functions_068 + 1);
      real _expensive_functions_069 = exp(-0.15910898965791567*v);
      real _expensive_functions_070 = exp(0.049333991119881598*v);
      real thf = 1.0/(1.183856958289087e-5*_expensive_functions_069 + 6.3055491858172754*_expensive_functions_070);
      real jss = hss;
      real _expensive_functions_071 = exp(0.02600780234070221*v);
      real _expensive_functions_072 = exp(-0.12075836251660427*v);
      real tj = 2.0379999999999998 + 1.0/(0.31319363947387729*_expensive_functions_071 + 1.1315282095590072e-7*_expensive_functions_072);
      real _expensive_functions_073 = exp(-0.035650623885918005*v);
      real _expensive_functions_074 = exp(0.017649135192375574*v);
      real ths = 1.0/(0.0051646702353817919*_expensive_functions_073 + 0.36987619372096325*_expensive_functions_074);
      real _expensive_functions_075 = exp(0.16431153466973381*v);
      real hspss = 1.0/(2281075.8166971938*_expensive_functions_075 + 1);
      real thsp = 3.0*ths;
      real tjp = 1.46*tj;
      real tmL = tm;
      real _expensive_functions_076 = exp(-_dt/ta);
      real _a_RLA = _expensive_functions_076 - 1;
      real _a_RLB = -ass;
      real _expensive_functions_077 = exp(-_dt/ta);
      real _ap_RLA = _expensive_functions_077 - 1;
      real _ap_RLB = -apss;
      real _expensive_functions_078 = exp(-_dt/td);
      real _d_RLA = _expensive_functions_078 - 1;
      real _d_RLB = -dss;
      real _expensive_functions_079 = exp(-_dt/tfcaf);
      real _fcaf_RLA = _expensive_functions_079 - 1;
      real _fcaf_RLB = -fcass;
      real _expensive_functions_080 = exp(-_dt/tfcafp);
      real _fcafp_RLA = _expensive_functions_080 - 1;
      real _fcafp_RLB = -fcass;
      real _expensive_functions_081 = exp(-_dt/tfcas);
      real _fcas_RLA = _expensive_functions_081 - 1;
      real _fcas_RLB = -fcass;
      real _expensive_functions_082 = exp(-_dt/tff);
      real _ff_RLA = _expensive_functions_082 - 1;
      real _ff_RLB = -fss;
      real _expensive_functions_083 = exp(-_dt/tffp);
      real _ffp_RLA = _expensive_functions_083 - 1;
      real _ffp_RLB = -fss;
      real _expensive_functions_084 = exp(-_dt/tfs);
      real _fs_RLA = _expensive_functions_084 - 1;
      real _fs_RLB = -fss;
      real _hL_RLB = -hLss;
      real _hLp_RLB = -hLpss;
      real _expensive_functions_087 = exp(-_dt/thf);
      real _hf_RLA = _expensive_functions_087 - 1;
      real _hf_RLB = -hss;
      real _expensive_functions_088 = exp(-_dt/ths);
      real _hs_RLA = _expensive_functions_088 - 1;
      real _hs_RLB = -hss;
      real _expensive_functions_089 = exp(-_dt/thsp);
      real _hsp_RLA = _expensive_functions_089 - 1;
      real _hsp_RLB = -hspss;
      real _expensive_functions_090 = exp(-_dt/tiF_001);
      real _iF_RLA = _expensive_functions_090 - 1;
      real _iF_RLB = -iss;
      real _expensive_functions_091 = exp(-_dt/tiFp);
      real _iFp_RLA = _expensive_functions_091 - 1;
      real _iFp_RLB = -iss;
      real _expensive_functions_092 = exp(-_dt/tiS_001);
      real _iS_RLA = _expensive_functions_092 - 1;
      real _iS_RLB = -iss;
      real _expensive_functions_093 = exp(-_dt/tiSp);
      real _iSp_RLA = _expensive_functions_093 - 1;
      real _iSp_RLB = -iss;
      real _expensive_functions_094 = exp(-_dt/tj);
      real _j_RLA = _expensive_functions_094 - 1;
      real _j_RLB = -jss;
      real _jca_RLB = -fcass;
      real _expensive_functions_096 = exp(-_dt/tjp);
      real _jp_RLA = _expensive_functions_096 - 1;
      real _jp_RLB = -jss;
      real _expensive_functions_097 = exp(-_dt/tm);
      real _m_RLA = _expensive_functions_097 - 1;
      real _m_RLB = -mss;
      real _expensive_functions_098 = exp(-_dt/tmL);
      real _mL_RLA = _expensive_functions_098 - 1;
      real _mL_RLB = -mLss;
      real _expensive_functions_099 = exp(-_dt*km2n);
      real _nca_RLA = _expensive_functions_099 - 1;
      real _nca_RLB = -anca*k2n/km2n;
      real _expensive_functions_100 = exp(-_dt/txk1);
      real _xk1_RLA = _expensive_functions_100 - 1;
      real _xk1_RLB = -xk1ss;
      real _expensive_functions_101 = exp(-_dt/txrf);
      real _xrf_RLA = _expensive_functions_101 - 1;
      real _xrf_RLB = -xrss;
      real _expensive_functions_102 = exp(-_dt/txrs);
      real _xrs_RLA = _expensive_functions_102 - 1;
      real _xrs_RLB = -xrss;
      real _expensive_functions_103 = exp(-_dt/txs1);
      real _xs1_RLA = _expensive_functions_103 - 1;
      real _xs1_RLB = -xs1ss;
      real _expensive_functions_104 = exp(-_dt/txs2);
      real _xs2_RLA = _expensive_functions_104 - 1;
      real _xs2_RLB = -xs2ss;
      //get the other differential updates
      ...
      real INaL = GNaL_001*mL*(-ENa + v)*(fINaLp*hLp + hL*(1.0 - fINaLp));
      ...
      real Ito = Gto_001*(-EK + v)*(a*i*(1.0 - fItop) + ap*fItop*ip);
      ...
      real ICaL = PCa_001*PhiCaL*d*(1.0 - fICaLp)*(f*(1.0 - nca) + fca*jca*nca) + PCap*PhiCaL*d*fICaLp*(fcap*jca*nca + fp*(1.0 - nca));
      ...
      real IKr = 0.43033148291193518*GKr_001*_expensive_functions_046*rkr*xr*(-EK + v);
      ...
      real IKs = GKs_001*KsCa*xs1*xs2*(-EKs + v);
      ...
      real IK1 = GK1_001*_expensive_functions_057*rk1*xk1*(-EK + v);
      ...
      real INaCa_i = 0.80000000000000004*Gncx_001*allo*(JncxCa*zca + JncxNa*zna);
      real h1_001 = 1 + nass*(hna + 1)/kna3;
      real h2_001 = hna*nass/(h1_001*kna3);
      real h3_001 = 1.0/h1_001;
      real h4_001 = 1.0 + nass*(1 + nass/kna2)/kna1;
      real h5_001 = (nass*nass)/(h4_001*kna1*kna2);
      real h6_001 = 1.0/h4_001;
      real h7_001 = 1.0 + nao*(1.0 + 1.0/hna)/kna3;
      real h8_001 = nao/(h7_001*hna*kna3);
      real h9_001 = 1.0/h7_001;
      real k3p_001 = h9_001*wca;
      real k3pp_001 = h8_001*wnaca;
      real k3_001 = k3p_001 + k3pp_001;
      real k4p_001 = h3_001*wca/hca;
      real k4pp_001 = h2_001*wnaca;
      real k4_001 = k4p_001 + k4pp_001;
      real k6_001 = cass*h6_001*kcaon;
      real k7_001 = h2_001*h5_001*wna;
      real k8_001 = h11_001*h8_001*wna;
      real x1_001 = k2_001*k4_001*(k6_001 + k7_001) + k5_001*k7_001*(k2_001 + k3_001);
      real x2_001 = k1_001*k7_001*(k4_001 + k5_001) + k4_001*k6_001*(k1_001 + k8_001);
      real x3_001 = k1_001*k3_001*(k6_001 + k7_001) + k6_001*k8_001*(k2_001 + k3_001);
      real x4_001 = k2_001*k8_001*(k4_001 + k5_001) + k3_001*k5_001*(k1_001 + k8_001);
      real E1_001 = x1_001/(x1_001 + x2_001 + x3_001 + x4_001);
      real E2_001 = x2_001/(x1_001 + x2_001 + x3_001 + x4_001);
      real E3_001 = x3_001/(x1_001 + x2_001 + x3_001 + x4_001);
      real E4_001 = x4_001/(x1_001 + x2_001 + x3_001 + x4_001);
      real allo_001 = 1.0/((KmCaAct_001*KmCaAct_001)/(cass*cass) + 1.0);
      real JncxNa_001 = -3.0*E1_001*k8_001 - E2_001*k3pp_001 + E3_001*k4pp_001 + 3.0*E4_001*k7_001;
      real JncxCa_001 = -E1_001*k1_001 + E2_001*k2_001;
      real INaCa_ss = 0.20000000000000001*Gncx_001*allo_001*(JncxCa_001*zca + JncxNa_001*zna);
      ...
      real a3 = k3p_002*((ko/Kko)*(ko/Kko))/(((1.0 + ko/Kko)*(1.0 + ko/Kko)) + ((1.0 + nao/Knao)*(1.0 + nao/Knao)*(1.0 + nao/Knao)) - 1.0);
      ...
      real x1_002 = a1*a2*a4 + a1*a2*b3 + a2*b3*b4 + b2*b3*b4;
      real x2_002 = a1*a2*a3 + a2*a3*b4 + a3*b1*b4 + b1*b2*b4;
      real x3_002 = a2*a3*a4 + a3*a4*b1 + a4*b1*b2 + b1*b2*b3;
      real x4_002 = a1*a3*a4 + a1*a4*b2 + a1*b2*b3 + b2*b3*b4;
      real E1_002 = x1_002/(x1_002 + x2_002 + x3_002 + x4_002);
      real E2_002 = x2_002/(x1_002 + x2_002 + x3_002 + x4_002);
      real E3_002 = x3_002/(x1_002 + x2_002 + x3_002 + x4_002);
      real E4_002 = x4_002/(x1_002 + x2_002 + x3_002 + x4_002);
      real JnakNa = 3.0*E1_002*a3 - 3.0*E2_002*b3;
      real JnakK = -2.0*E3_002*a1 + 2.0*E4_002*b1;
      real INaK = Pnak_001*(JnakK*zk + JnakNa*zna);
      real _expensive_functions_060 = exp(-0.054525627044711013*v);
      real xkb = 1.0/(2.2023634509492389*_expensive_functions_060 + 1.0);
      real IKb = GKb_001*xkb*(-EK + v);
      ...
      real Jrelnp_diff = (Jrel_inf_001 - Jrelnp)/tau_rel_001;
      ...
      real Jrelp_diff = (-Jrelp + Jrelp_inf_001)/tau_relp_001;
      ...
      real Jup = -Jleak + Jupnp_001*(1.0 - fJupp) + Jupp_001*fJupp;
      ...
      real Bcai = 1.0/(cmdnmax_001*kmcmdn*(1.0/(cai + kmcmdn)/(cai + kmcmdn)) + kmtrpn*trpnmax*(1.0/(cai + kmtrpn)/(cai + kmtrpn)) + 1.0);
      ...
      real cass_diff = Bcass*(0.5*Acap*(-ICaL + 2.0*INaCa_ss)/(F*vss) - Jdiff + Jrel_001*vjsr/vss);
      ...
      real INa = (m*m*m)*GNa*(-ENa + v)*(fINap*hp*jp + h*j*(1.0 - fINap));
