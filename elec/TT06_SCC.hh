...
REACTION_FACTORY(TT06_SCC)(OBJECT* obj, const double dt, const int numPoints, const ThreadTeam& group);    
...
namespace TT06_SCC
{
   ...
   class ThisReaction : public Reaction
   {
    ...
    public:
      ...
      Interpolation _interpolant[2+1];
      FRIEND_FACTORY(TT06_SCC)(OBJECT* obj, const double dt, const int numPoints, const ThreadTeam& group);
   };
}
