...
REACTION_FACTORY(fenton_karma_SCC)(OBJECT* obj, const double dt, const int numPoints, const ThreadTeam& group);    
...
namespace fenton_karma_SCC
{
   ...
   struct State
   {
      ...
      double v[SIMDOPS_FLOAT64V_WIDTH];
   ...
   class ThisReaction : public Reaction
   {
    ...
    public:
      ...
      FRIEND_FACTORY(fenton_karma_SCC)(OBJECT* obj, const double dt, const int numPoints, const ThreadTeam& group);
   };
}
