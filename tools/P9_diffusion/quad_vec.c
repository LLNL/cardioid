...
void diff_cpu(Real* d_psi, Real* d_npsi, Real* d_sigmaX, Real* d_sigmaY, Real* d_sigmaZ,int Lii, int Ljj, int Lkk)
{
  ...
  for(int cjj=1;cjj<Ljj;cjj+=15)
  for(int ckk=1;ckk<Lkk;ckk+=15)
  {
    ...
    for(int x=1;x<Lii;x++)
    {
        ...
        {                                 
          ...
          {                               
            ...
            vector4 zxm = sX * ( vp0 - vm0 + wp0 - wm0 ) * 0.5;
            vector4 zym = sY * ( v0p - v0m + w0p - w0m ) * 0.5;
          
            vector4 zm = zzm + xzm + xym;
            vector4 zm0, zm1;
        ...
        {                                 
          ...
          {                               
            ...
            vector4 xym = sY * (vp0 - vm0 + wp0 - wm0 ) * 0.5;
            vector4 xzm = sZ * (v0p - v0m + w0p - w0m ) * 0.5;
        ...
        {                                 
          ...
          {                               
            ...
            vector4 yxm = sX * (vp0 - vm0 + wp0 - wm0 ) * 0.5;
            vector4 yym = sY * (w00 - v00);
            vector4 yzm = sZ * (v0p - v0m + w0p - w0m ) * 0.5;
