...
class Compare_parallel_v_serial():
    ...
    def __init__(self, directory, full=True):
        ...
        self.full = full
        self.case_1_dir = "ikr_block_0/gNaL015"
        self.case_2_dir = "ikr_block_0/gNaL015_r"
        self.case_3_dir = "ikr_block_66/c_3"
        self.case_4_dir = "ikr_block_66/c_3_r"
        self.case_legends = ["Control", "Control Ospec","E4031","E4031 Ospec"]
        if self.full:
    ...
    def load_data(self):
        ...
        for ii in range(n_cases):
            if ii == 0:
                case_data = self.load_case_data_serial(self.directory + os.sep + self.case_1_dir)
            elif ii == 1:
                case_data = self.load_case_data_serial(self.directory + os.sep + self.case_2_dir)
            elif ii == 2:
                case_data = self.load_case_data_serial(self.directory + os.sep + self.case_3_dir)
            else:
                case_data = self.load_case_data_serial(self.directory + os.sep + self.case_4_dir)
    ...
    def save_data(self):
        np.savetxt('LEAD1DATA.csv',self.ECG_data,delimiter=',')
