...
class Priming():
    ...
    def __init__(self,
        ...
        self.ex_dir = "experiment_19"
        self.l1_param_dirs = ['ikr_block_0/c_2', 'ikr_block_0/c_3', 'ikr_block_0/c_3.5', 'ikr_block_0/c_4']
        self.l1_param_labels = ["c X 2", "c X 3", "c X 3.5", "c X 4"]
        self.l2_param_dirs = ['gNaL015','gNal016','gNal017','gNal018','gNal019','gNal020']
        self.l2_param_labels = ['gNaL015','gNal016','gNal017','gNal018','gNal019','gNal020']
