...
#include <assert.h>
#include <string.h>
enum enumIndex{ AFIndex, GtoIndex, xtofIndex, ytofIndex, nVar};
...
static VARINFO varInfo[] =
{
   ...
   {"xtof",PSTATE_TYPE,xtofIndex,0,0,0,0,"1"},
   {"ytof",PSTATE_TYPE,ytofIndex,1,1,1,1,"1"}
};
typedef struct parameters_str { double  AF, Gto;} PARAMETERS;
