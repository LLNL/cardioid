...
double TT04_CellML_Endo::constants_[46];
double TT04_CellML_Endo::defaultState_[17];
...
TT04_CellML_Endo::TT04_CellML_Endo()
{
...
/** Everything below this point is the TT04 endo model generated code
