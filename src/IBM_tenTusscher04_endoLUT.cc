...
#include "IBM_tenTusscher04_endoLUT.hh"
  ...
  char IBM_tenTusscher04_endoLUT::TT04LUT_EVfilename[255];
  TTParameterStruct IBM_tenTusscher04_endoLUT::TT04LUT_ttps; //fps stands for TTParameterStruct
     
  // lookup tables
  double IBM_tenTusscher04_endoLUT::TT04LUT_rec_ipK[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_d_inf[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_f_inf[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_tau_m[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_tau_h[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_tau_j[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_tau_Xr1[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_tau_Xr2[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_tau_Xs[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_tau_r[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_tau_s[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_m_inf[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_h_inf[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_j_inf[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_Xr1_inf[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_Xr2_inf[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_Xs_inf[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_r_inf[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_s_inf[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_tau_d[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_tau_f[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_NaCa_P1[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_NaCa_P2[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_NaK_P1[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_CaL_P1[V_RESOLUTION];
  double IBM_tenTusscher04_endoLUT::TT04LUT_CaL_P2[V_RESOLUTION];
                                                                                                                                            
                                                                                                                                                 
     
IBM_tenTusscher04_endoLUT::IBM_tenTusscher04_endoLUT() 
{
...
void IBM_tenTusscher04_endoLUT::TT04LUT_Init()
{
...
void IBM_tenTusscher04_endoLUT::TT04LUT_InitParameters() 
{
/*
  y_TT[tt_V]    = -0.0862;
...
void IBM_tenTusscher04_endoLUT::TT04LUT_InitTable()
{
