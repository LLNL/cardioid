...
double TT06_CellML_Epi::constants_[53];
double TT06_CellML_Epi::defaultState_[19];
...
TT06_CellML_Epi::TT06_CellML_Epi()
{
...
double TT06_CellML_Epi::calc(double dt, double Vm, double iStim)
{
   double dummy  = 0.;
   double rates[19];
   double algebraic[70];
...
/** Everything below this point is the TT06 epi model generated code
