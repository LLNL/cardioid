  ...
  pulse_(pulse)
{
   ...
   int myrank;								
   int nLocal = stimList_.size();						// Local # of box stimulus gids within tissue; the _ at end means this variable only apply to current class, not others (just a naming convention)
