...
void OHaraRudyFluxesFunc(CELLPARMS *parmsPtr, STATE *state, int pOffset, DERIVED *derived, double dt )
{
   FLUXES J; 
...
COMPONENTINFO OHaraRudyFluxesInit()
{
   COMPONENTINFO info;
   info.nVar   = nVar; 
   info.varInfo = varInfo;
   info.func = OHaraRudyFluxesFunc;
   info.access = OHaraRudyFluxesAccess;
   return info;
}
