...
#include <assert.h>
#include <string.h>
enum enumIndex{ GNaLIndex, mLIndex, hLIndex, nVar};
static const char *compName = "INaL";
static VARINFO varInfo[] =
{
   {"GNaL",PARAMETER_TYPE,GNaLIndex,0.0,0.0,0.0025,0.0025,"mS/uF"},
   {"mL",PSTATE_TYPE,mLIndex,0.0,0.0,0.0,0.0,"1"},
   {"hL",PSTATE_TYPE,hLIndex,1.0,1.0,1.0,1.0,"1"}
};
