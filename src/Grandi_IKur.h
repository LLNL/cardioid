...
#include <assert.h>
#include <string.h>
enum enumIndex{ GKurIndex, xkurIndex, ykurIndex, nVar};
static const char *compName = "IKur";
static VARINFO varInfo[] =
{
  {"GKur",PARAMETER_TYPE,GKurIndex,0.045,0.045,0.045,0.045,"mS/uF"},
  {"xkur",PSTATE_TYPE,xkurIndex,0.0,0.0,0.0,0.0,"1"},
  {"ykur",PSTATE_TYPE,ykurIndex,1.0,1.0,1.0,1.0,"1"}
};
typedef struct parameters_str { double  GKur;} PARAMETERS;
