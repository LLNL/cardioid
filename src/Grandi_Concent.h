...
static VARINFO varInfo[] =
{
  ...
  {"Ki",PSTATE_TYPE,KiIndex,120.0,120.0,120.0,120.0,"mM"},
  {"Casr",PSTATE_TYPE,CasrIndex,0.01,0.01,0.01,0.01,"mM"},
  {"Caj",PSTATE_TYPE,CajIndex,1.7e-4,1.7e-4,1.7e-4,1.7e-4,"mM"},
  {"Casl",PSTATE_TYPE,CaslIndex,1.0e-4,1.0e-4,1.0e-4,1.0e-4,"mM"},
  {"Cai",PSTATE_TYPE,CaiIndex,1.0e-4,1.0e-4,1.0e-4,1.0e-4,"mM"}
};
