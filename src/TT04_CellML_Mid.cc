...
double TT04_CellML_Mid::constants_[46];
double TT04_CellML_Mid::defaultState_[17];
...
TT04_CellML_Mid::TT04_CellML_Mid()
{
...
double TT04_CellML_Mid::calc(double dt, double Vm, double iStim)
{
   double dummy  = 0.;
   double rates[17];
   double algebraic[67];
...
/** Everything below this point is the TT04 mid model generated code
