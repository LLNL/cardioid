...
double TT06_CellML_Endo::constants_[53];
double TT06_CellML_Endo::defaultState_[19];
...
TT06_CellML_Endo::TT06_CellML_Endo()
{
...
double TT06_CellML_Endo::calc(double dt, double Vm, double iStim)
{
   double dummy  = 0.;
   double rates[19];
   double algebraic[70];
...
/** Everything below this point is the TT06 endo model generated code
