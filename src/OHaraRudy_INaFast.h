...
void OHaraRudy_INaFastAccess(int type,int index,double *value, double  *parmsPtr, double *statePtr)
{
...
COMPONENTINFO OHaraRudy_INaFastInit()
{
   ...
   info.func = OHaraRudy_INaFastFunc;
   info.access = OHaraRudy_INaFastAccess;
   return info;
}
#ifdef doEnd
#define ENDCODE() {\
